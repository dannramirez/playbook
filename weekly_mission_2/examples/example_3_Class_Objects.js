...
const dannStudent = new Student("Dann", 20, ["NodeJs", "Python", "JavaScript"])
console.log("Ejemplo 3: Instanciar un objeto con atributos")
console.log(dannStudent)
...
const myRepo = new Repository("LaunchX", "dannramirez", "js", 100)
...
const woopa = new Ajolonauta("Tisa", 1, [])
...
const dannDev = new Developer("Dann", "js", ["CSS", "JS", "TS"]);
console.log(dannDev);
...
const dannLaunchXDev = new LaunchXStudent("Dann", "js", ["CSS", "JS", "TS"]);
console.log(dannLaunchXDev);
console.log(dannLaunchXDev.getName) // getter de la clase padre rehusada en la clase hija
...
const viajero1 = new Viajero("Dann", "LaunchX", "Node JS", "Abril 2022")
